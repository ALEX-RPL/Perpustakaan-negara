...
<head>
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    .pagination .page-link{background:var(--card);border:1px solid #e8ecf4;color:var(--text-2);text-decoration:none;transition:all .15s;display:inline-flex;align-items:center;}
    ...
    .pagination .page-item.disabled .page-link{opacity:.5;cursor:not-allowed;background:#f1f5f9;}
